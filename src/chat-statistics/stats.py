...
class ChatStatistics:
    """Generate chat statistics from telegram chat jason file 
    """
    def __init__(self, chat_json : Union[str, Path]):
        """
        Args:
            chat_json (Union[str, Path]): path to telegram jason file
        """
    ...
    def generate_word_cloud(self,output_dir):
        """_summary_
        Args:
            output_dir (_type_): path to output directory for word cloud image
        """
        text_content = ''
        ...
        # normilize, reshape for final wordcloud
